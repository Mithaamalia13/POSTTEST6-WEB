    ...
    <div class="info_pendaki">
        <table>
            ...
            <tr class="isi">
                ...
                <td><?=$row['tgl_turun']?></td>
                <td>
                    <?=$row['status_pendakian']?>
                    <?php 
                        $masih = 'Selesai';
                        $track = 'On-Track';
                        $stts = mysqli_query($koneksi, "INSERT INTO datapendaki (status_pendakian) VALUES ('$masih' or '$track')");
                        if($row['tgl_turun'] <= date("Y-m-d")){
                            $row['status_pendakian'] === $masih;
                        }else {
                            $row['status_pendakian'] === $track;
                        }
                    ?>
                </td>
